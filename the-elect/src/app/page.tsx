  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-[#000000] text-white font-sans selection:bg-[#FFFF00] selection:text-black">
      ...
      <section className="w-full flex flex-col items-center justify-center text-center py-24 px-6 border-b-8 border-[#FFFF00]">
        <h1 className="text-5xl md:text-7xl font-extrabold mb-6 text-[#FFFF00] tracking-tight uppercase" data-read-aloud="true">
          {t.hero.title}
        </h1>
        <p className="text-2xl md:text-3xl max-w-4xl mb-12 font-bold leading-relaxed" data-read-aloud="true">
          {t.hero.subtitle}
        </p>
      ...
      <section className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-3 gap-12 py-24 px-6">
        <div className="bg-[#0000FF] p-8 border-4 border-white">
          <h2 className="text-3xl font-bold mb-4 text-[#FFFF00] uppercase" data-read-aloud="true">
            {t.features.feature1_title}
          </h2>
          <p className="text-xl font-medium leading-relaxed text-white" data-read-aloud="true">
      ...
      <footer className="w-full text-center py-12 mt-auto border-t-4 border-white bg-[#000000]">
        <p className="text-xl font-bold text-[#FFFF00]" data-read-aloud="true">
          {t.footer.text}
        </p>
      </footer>
    </div>
